...
function tinys_load_textdomain() {
	load_plugin_textdomain( 'moontinyslider', false, dirname( __FILE__ ) . "/languages" );
}
...
function tinys_assets(){
	wp_enqueue_style('moontinyslider-css','//cdnjs.cloudflare.com/ajax/libs/tiny-slider/2.8.4/tiny-slider.css',null,'1.0');
	wp_enqueue_script('moontinyslider-js','//cdnjs.cloudflare.com/ajax/libs/tiny-slider/2.8.4/min/tiny-slider.js',null,'1.0',true);

	wp_enqueue_script('moontinyslider-main-js',plugin_dir_url(__FILE__)."/assets/js/main.js",array('jquery'),'1.0',true);
}
